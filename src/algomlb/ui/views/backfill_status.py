...
def _get_backfill_matrix(engine):
    ...
    layers = ["Bronze", "Silver", "Gold", "Uranium"]
...
def show_backfill_status():
    ...
    st.markdown("---")
    st.info("💡 Tip: Multi-core XGBoost training is currently active. Logs may 'pause' during 20-trial Optuna sweeps.")
