...
class GameLineupORM(Base):
    ...
    game_date: Mapped[datetime.date] = mapped_column(Date, nullable=False, index=True)
    team_side: Mapped[str] = mapped_column(String(4), nullable=False)
...
class HistoricalOddsORM(Base):
    ...
    odds_type: Mapped[str] = mapped_column(String(10), nullable=False)
...
class RetrosheetEventORM(Base):
    ...
    event_text: Mapped[str] = mapped_column(String(255))
    ...
    bat_team: Mapped[str] = mapped_column(String(5))
    pit_team: Mapped[str] = mapped_column(String(5))
    score_v: Mapped[int] = mapped_column(Integer, default=0)
    score_h: Mapped[int] = mapped_column(Integer, default=0)
    batter_id: Mapped[str] = mapped_column(String(20))
    pitcher_id: Mapped[str] = mapped_column(String(20))
    lp: Mapped[int] = mapped_column(Integer)
    bat_f: Mapped[int] = mapped_column(Integer)
    batter_hand: Mapped[Optional[str]] = mapped_column(String(1))
    pitcher_hand: Mapped[Optional[str]] = mapped_column(String(1))
    balls: Mapped[int] = mapped_column(Integer, default=0)
    strikes: Mapped[int] = mapped_column(Integer, default=0)
    count_text: Mapped[Optional[str]] = mapped_column(String(5))
    ...
    double_flag: Mapped[int] = mapped_column(Integer, default=0)
...
class OpenMeteoWeatherProgressionORM(Base):
    ...
    temp_delta_game: Mapped[Optional[float]] = mapped_column(Numeric(5, 1))
...
class GameManagerRegistryORM(Base):
    ...
    game_date: Mapped[datetime.date] = mapped_column(Date, nullable=False, index=True)
    season: Mapped[int] = mapped_column(Integer, nullable=False, index=True)
    home_away: Mapped[str] = mapped_column(String(10), nullable=False)
...
class ManagerHookEventORM(Base):
    ...
    tto_at_hook: Mapped[int] = mapped_column(Integer, nullable=False)
    score_diff_at_hook: Mapped[int] = mapped_column(Integer, nullable=False)
    base_state_at_hook: Mapped[int] = mapped_column(Integer, nullable=False)
...
class PitcherDailyUsageORM(Base):
    ...
    pa_count: Mapped[int] = mapped_column(Integer, default=0)
