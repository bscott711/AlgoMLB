...
def main():
    ...
    with session_factory() as session:
        ...
        turf_parks = ["rogers centre", "tropicana field", "chase field", "loandepot park", "globe life field"]
        fixed_roof_parks = ["tropicana field"]
        retractable_parks = ["rogers centre", "chase field", "t-mobile park", "american family field", "minute maid park", "loandepot park", "globe life field"]
